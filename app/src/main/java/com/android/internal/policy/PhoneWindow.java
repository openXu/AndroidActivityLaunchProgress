...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        final boolean targetPreHoneycomb = targetSdk < Build.VERSION_CODES.HONEYCOMB;
        final boolean targetPreIcs = targetSdk < Build.VERSION_CODES.ICE_CREAM_SANDWICH;
        final boolean targetPreL = targetSdk < Build.VERSION_CODES.LOLLIPOP;
